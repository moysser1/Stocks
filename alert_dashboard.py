...
# Google Sheets auth with PEM sanitization
scope = ["https://spreadsheets.google.com/feeds", "https://www.googleapis.com/auth/drive"]
# Sanitize the private key from secrets
_raw_key = st.secrets["GCP_PRIVATE_KEY"]
_pem = _raw_key.replace("\\n", "\n")
private_key = "\n".join([line.strip() for line in _pem.splitlines() if line.strip()])
creds_dict = {
...
# Weekend detection (Friday=4, Saturday=5)
